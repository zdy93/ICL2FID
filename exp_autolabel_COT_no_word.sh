...
output_file=TC_output/${agg_method}/${size}/out_AutoLabel_COT_${trans_model_name}_${few_shot_selection}_${data_name}_current_${use_current_explanation}_ground_${use_ground_explanation}.ipynb
