...
output_file=NER_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}/out_AutoLabel_NER_COT_AE_verification_COT_only_${cot_col}_${trans_model_name}_${few_shot_selection}_${entity_type}_${data_name}_${size}_${agg_method}.ipynb

papermill \
AutoLabel_NER_COT_AE_verification_COT_only.ipynb \
${output_file} \
-k py3.9-visa \
