...
output_file=NER_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/out_AutoLabel_NER_QA_verification_relabel_${trans_model_name}_${few_shot_selection}_${entity_type}_${data_name}_${size}_${agg_method}.ipynb

papermill \
AutoLabel_NER_QA_verification_relabel.ipynb \
${output_file} \
-k py3.9-visa \
