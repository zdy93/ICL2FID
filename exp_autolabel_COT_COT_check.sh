...
output_file=TC_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/out_AutoLabel_COT_COT_check_${trans_model_name}_${check_mode}_${few_shot_selection:0:3}_${word_few_shot_selection:0:3}_${verify_few_shot_selection:0:3}_${data_name}_current_${use_current_explanation}_ground_${use_ground_explanation}.ipynb
