...
directory=ALL_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}
...
output_file=ALL_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}/out_AutoLabel_COT_AE_all_${cot_col}_${trans_model_name}_${few_shot_selection}_${data_name}_${size}_${agg_method}.ipynb

papermill \
AutoLabel_COT_AE_all.ipynb \
${output_file} \
-k py3.9-visa \
