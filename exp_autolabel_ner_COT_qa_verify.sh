...
output_file=NER_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/out_AutoLabel_NER_COT_QA_verification_${cot_col}_${trans_model_name}_${few_shot_selection}_${entity_type}_${data_name}_${size}_${agg_method}.ipynb
else
...
output_file=NER_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}/out_AutoLabel_NER_COT_QA_verification_${cot_col}_${trans_model_name}_${few_shot_selection}_${entity_type}_${data_name}_${size}_${agg_method}.ipynb
fi
...
papermill \
AutoLabel_NER_COT_QA_verification.ipynb \
${output_file} \
-k py3.9-visa \
