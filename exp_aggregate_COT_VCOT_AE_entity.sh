...
label_symbol="^^^^"
text_column="context"
result_dir='/scratch/dzhang5/LLM/TWEET-FID/traintestfortest-results-autolabel-ner-ae-'${agg_method}
few_shot_num=8
output_dir=${output_dir}/${temperature}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}
result_dir=${result_dir}/${temperature}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}
