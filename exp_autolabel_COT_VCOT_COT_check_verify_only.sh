...
tweet_verify_few_shot_selection=${13:-"label_diversity_similarity"}
word_use_current_explanation=${14:-"False"}
word_use_ground_explanation=${15:-"False"}
...
output_file=TC_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/out_AutoLabel_COT_COT_COT_check_verify_only_${trans_model_name}_${check_mode}_${few_shot_selection:0:3}_${word_few_shot_selection:0:3}_${verify_few_shot_selection:0:3}_${tweet_verify_few_shot_selection:0:3}_${data_name}_current_${use_current_explanation}_ground_${use_ground_explanation}.ipynb
else
...
directory=TC_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}
output_file=TC_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/few_${few_shot_num}/out_AutoLabel_COT_COT_COT_check_verify_only_${trans_model_name}_${check_mode}_${few_shot_selection:0:3}_${word_few_shot_selection:0:3}_${verify_few_shot_selection:0:3}_${tweet_verify_few_shot_selection:0:3}_${data_name}_current_${use_current_explanation}_ground_${use_ground_explanation}.ipynb
fi


if [[ "$verify" == "True" ]]; then
data_path=${data_path_par}'/'${last_model_name}'_'${check_mode}'_'${word_few_shot_selection}'_COT_'${word_explanation_column}'_cur_'${word_use_current_explanation}'_ground_'${word_use_ground_explanation}'_aggregated_final_COT_'${v_tail}'expert.traintestfortest.csv'
else
...
papermill \
AutoLabel_COT_check_verify_only.ipynb \
${output_file} \
-k py3.9-visa \
...
-p verify_few_shot_selection ${tweet_verify_few_shot_selection} \
