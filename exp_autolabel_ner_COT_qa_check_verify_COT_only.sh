...
sen_verify=${12:-"True"}
verify_few_shot_selection=${13-'label_diversity_similarity'}
...
ori_data_path='/scratch/dzhang5/LLM/TWEET-FID/'${agg_method}'.traintestfortest.csv'
...
example_selection_label_column=${entity_type}_check_class
explanation_column=${entity_type}_check_explanation
...
output_file=NER_output/${agg_method}/${size}/lv_${label_version}_tv_${task_version}/out_AutoLabel_NER_COT_QA_check_verification__COT_only_${trans_model_name}_${few_shot_selection}_${entity_type}_${ori_data_name}_${sen_verify}_${size}_${agg_method}.ipynb

papermill \
AutoLabel_NER_COT_QA_check_verification_COT_only.ipynb \
${output_file} \
-k py3.9-visa \
